...
class _RegisterPage extends State<RegisterPage> {
  ...
  TextEditingController emailController = TextEditingController(
    text: (kDebugMode) ? "supercyp971@gmail.com" : "",
  );
  TextEditingController passwordController = TextEditingController(
    text: (kDebugMode) ? 'test123123' : "",
  );
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              pad(
                Text(currentError, style: const TextStyle(color: Colors.red)),
              ),
                          ...
                          onPressed: () {
                            if (_formKey.currentState!.validate()) {
                              var res = pbc
                                  ...
                                  .catchError((e) {
                                    print(e.toString());
                                    setState(() => currentError = e.response);
